        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-12">
              ...
              >
                 <div className="absolute inset-0 bg-[url('https://picsum.photos/id/1015/800/600')] bg-cover bg-center opacity-60 grayscale group-hover:scale-105 transition-transform duration-500"></div>
